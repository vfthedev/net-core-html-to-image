    ...
    public class HtmlConverter
    {
        ...
        static HtmlConverter()
        {
            ...
            else if (System.Runtime.InteropServices.RuntimeInformation.IsOSPlatform(System.Runtime.InteropServices.OSPlatform.Linux))
            {
                ...
                // Check if wkhtmltoimage package is installed
                // Process process = Process.Start(new ProcessStartInfo()
                // {
                //     CreateNoWindow = true,
                //     UseShellExecute = false,
                ...
                // else
                // {
                //     throw new Exception("wkhtmltoimage does not appear to be installed; go to https://wkhtmltopdf.org/downloads.html");
                // }
            }
            else
            {
                // unsupported plattform
                throw new Exception("What, are you trying to run this on ChromeOS? :D");
            }
        }
